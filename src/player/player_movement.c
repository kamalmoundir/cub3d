...
/*   Updated: 2025/05/30 19:20:55 by kmoundir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate_player(t_game *game)
{
	...
	game->player.direction.x = old_dir_x * cos_rot - game->player.direction.y
		* sin_rot;
	game->player.direction.y = old_dir_x * sin_rot + game->player.direction.y
		* cos_rot;
	old_plane_x = game->player.plane.x;
	game->player.plane.x = old_plane_x * cos_rot - game->player.plane.y
		* sin_rot;
	game->player.plane.y = old_plane_x * sin_rot + game->player.plane.y
		* cos_rot;
}
